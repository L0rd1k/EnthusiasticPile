# Generated by Django 3.1 on 2020-11-02 16:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actors', models.ManyToManyField(related_name='film_actor', to='Blog.Actor', verbose_name='актеры')),
                ...
                ('directors', models.ManyToManyField(related_name='film_director', to='Blog.Actor', verbose_name='режиссер')),
                ('genres', models.ManyToManyField(to='Blog.Genre', verbose_name='жанры')),
            ],
            options={
                'verbose_name': 'Фильм',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='Blog.movie', verbose_name='фильм')),
